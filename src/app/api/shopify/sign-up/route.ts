import { CUSTOMER_TOKEN_CREATE_MUTATION, SIGNUP_MUTATION } from '@/lib/shopify/customer/queries';
import type { NextRequest } from 'next/server'
import { NextResponse } from 'next/server'
import { cookies } from 'next/headers';
import { CustomerCreateResponse, CustomerInput } from '@/lib/shopify/customer/types';
