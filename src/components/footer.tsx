      ...
      <div className="flex w-full container">
        <div className="w-4/5 flex flex-col gap-12">
          <ul className="flex flex-col items-start gap-4">
            <li><Link href="/" className="text-md uppercase transition-colors duration-200 hover:text-neutral-400!">Home</Link></li>
            <li><Link href="/collections/all" className="text-md! uppercase text-black! hover:text-neutral-400! transition-colors duration-200">Products</Link></li>
            <li><Link href="/story" className="text-md! uppercase text-black! hover:text-neutral-400! transition-colors duration-200">Story</Link></li>
            <li><Link href="/about-us" className="text-md! uppercase text-black! hover:text-neutral-400! transition-colors duration-200">About</Link></li>
          </ul>
          <div>
