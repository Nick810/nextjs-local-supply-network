...
import { extractImageVariants } from '@/lib/utils';
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className={`absolute ${positionClass} transform text-center w-full px-[5%] max-w-[800px]`}>
        ...
        <Link href="/all-products" className="btn w-full max-w-[320px]! m-auto rounded-md bg-[#f3f3f3] border border-black text-black! hover:bg-[#f3f3f3] transition-all duration-200 ease-in">Shop Now</Link>
      </div>
    </div>
  )
}
